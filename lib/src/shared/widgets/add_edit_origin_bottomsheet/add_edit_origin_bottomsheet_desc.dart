...
class AddEditOriginBottomsheetDesc extends StatefulWidget {
  const AddEditOriginBottomsheetDesc({
    super.key,
    this.initialDesc,
  ...
  @override
  State<AddEditOriginBottomsheetDesc> createState() =>
      _BottomSheetAddBoardLinkTitleFieldState();
}

class _BottomSheetAddBoardLinkTitleFieldState
    extends State<AddEditOriginBottomsheetDesc> {
