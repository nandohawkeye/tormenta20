...
class AddEditPowerBottomsheetTitle extends StatefulWidget {
  const AddEditPowerBottomsheetTitle({
    super.key,
    this.initialTitle,
  ...
  @override
  State<AddEditPowerBottomsheetTitle> createState() =>
      _BottomSheetAddBoardLinkTitleFieldState();
}

class _BottomSheetAddBoardLinkTitleFieldState
    extends State<AddEditPowerBottomsheetTitle> {
