...
class BottomSheetAddEditBoardCharacterPlayerField extends StatefulWidget {
  const BottomSheetAddEditBoardCharacterPlayerField({
    super.key,
    this.initialTitle,
  ...
  @override
  State<BottomSheetAddEditBoardCharacterPlayerField> createState() =>
      _BottomSheetAddBoardLinkTitleFieldState();
}

class _BottomSheetAddBoardLinkTitleFieldState
    extends State<BottomSheetAddEditBoardCharacterPlayerField> {
