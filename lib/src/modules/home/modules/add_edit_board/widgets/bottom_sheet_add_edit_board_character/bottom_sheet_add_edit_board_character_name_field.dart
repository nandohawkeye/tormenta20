...
class BottomSheetAddEditBoardCharacterNameField extends StatefulWidget {
  const BottomSheetAddEditBoardCharacterNameField({
    super.key,
    this.initialTitle,
  ...
  @override
  State<BottomSheetAddEditBoardCharacterNameField> createState() =>
      _BottomSheetAddBoardLinkTitleFieldState();
}

class _BottomSheetAddBoardLinkTitleFieldState
    extends State<BottomSheetAddEditBoardCharacterNameField> {
