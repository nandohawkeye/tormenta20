...
class BottomSheetAddEditBoardPlayerNamecharacterField extends StatefulWidget {
  const BottomSheetAddEditBoardPlayerNamecharacterField({
    super.key,
    this.initialTitle,
  ...
  @override
  State<BottomSheetAddEditBoardPlayerNamecharacterField> createState() =>
      _BottomSheetAddBoardLinkTitleFieldState();
}

class _BottomSheetAddBoardLinkTitleFieldState
    extends State<BottomSheetAddEditBoardPlayerNamecharacterField> {
