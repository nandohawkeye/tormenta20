...
import 'package:tormenta20/src/modules/home/modules/add_edit_board/widgets/bottom_sheet_add_edit_board_player/bottom_sheet_add_edit_board_player_file_image_selector.dart';
import 'package:tormenta20/src/modules/home/modules/add_edit_board/widgets/bottom_sheet_add_edit_board_player/bottom_sheet_add_edit_board_player_token_card.dart';

class BottomSheetAddEditBoardPlayerTokens extends StatefulWidget {
  const BottomSheetAddEditBoardPlayerTokens(
      {super.key, required this.store, required this.size});

  final BotomSheetAddEditBoardPlayerStore store;
  final double size;

  @override
  State<BottomSheetAddEditBoardPlayerTokens> createState() =>
      _BottomSheetAddEditBoardPlayerTokensState();
}

class _BottomSheetAddEditBoardPlayerTokensState
    extends State<BottomSheetAddEditBoardPlayerTokens> {
      ...
      child: AnimatedBuilder(
          ...
          builder: (_, __) {
            ...
            return ListView.separated(
              ...
              itemBuilder: (_, index) {
                if (index == 0) {
                  return BottomSheetAddEditBoardPlayerFileImageSelector(
                ...
                return BottomSheetAddEditBoardPlayerTokenCard(
