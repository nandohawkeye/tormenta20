...
class BottomSheetAddEditBoardPlayerNameField extends StatefulWidget {
  const BottomSheetAddEditBoardPlayerNameField({
    super.key,
    this.initialTitle,
  ...
  @override
  State<BottomSheetAddEditBoardPlayerNameField> createState() =>
      _BottomSheetAddBoardLinkTitleFieldState();
}

class _BottomSheetAddBoardLinkTitleFieldState
    extends State<BottomSheetAddEditBoardPlayerNameField> {
