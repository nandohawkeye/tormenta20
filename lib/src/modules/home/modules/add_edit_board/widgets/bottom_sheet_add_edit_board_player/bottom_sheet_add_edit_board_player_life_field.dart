...
class BottomSheetAddEditBoardPlayerLifeField extends StatefulWidget {
  const BottomSheetAddEditBoardPlayerLifeField({
    super.key,
    this.initialLife,
  ...
  @override
  State<BottomSheetAddEditBoardPlayerLifeField> createState() =>
      _BottomSheetAddBoardLinkTitleFieldState();
}

class _BottomSheetAddBoardLinkTitleFieldState
    extends State<BottomSheetAddEditBoardPlayerLifeField> {
