...
class BottomSheetAddEditBoardPlayerDefenseField extends StatefulWidget {
  const BottomSheetAddEditBoardPlayerDefenseField({
    super.key,
    this.initialDefense,
  ...
  @override
  State<BottomSheetAddEditBoardPlayerDefenseField> createState() =>
      _BottomSheetAddBoardLinkTitleFieldState();
}

class _BottomSheetAddBoardLinkTitleFieldState
    extends State<BottomSheetAddEditBoardPlayerDefenseField> {
