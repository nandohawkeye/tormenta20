...
import 'package:tormenta20/src/modules/home/modules/add_edit_equipaments/widgets/add_edit_equipment_shield_type.dart';
...
class ShieldWidgetsGroup extends StatelessWidget {
  const ShieldWidgetsGroup(this.controller, this.hasInited, {super.key});
    ...
    return AddEditEquipmentScreenItem(
      ...
      child: Column(
        ...
        children: [
          ...
          T20UI.spaceHeight,
          AddEditEquipmentShieldType(controller.shieldTypeStore),
          T20UI.spaceHeight,
          Padding(
            padding: T20UI.horizontallScreenPadding,
