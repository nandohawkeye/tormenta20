          ...
          children: [
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Flexible(
                              child: Text(
                                'Nivel ${character.classes.length.toString().padLeft(2, '0')}  :  ${CharacterBoardUtils.handleAllClassesTypeTitle(character.classes)}',
                                maxLines: 2,
                                style: TextStyle(
                                  fontSize: 14,
                                  color: palette.textSecundary,
            ...
            Padding(
              ...
              child: LinearProgressIndicator(
                value: (((character.currentLife * 100) / character.life) / 100),
            ...
            Padding(
              padding: T20UI.horizontalPadding,
              child: LinearProgressIndicator(
                value: (((character.currentMana * 100) / character.mana) / 100),
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: otherCharacters
                      .map(
                        (e) => BoardViewCharacterFieldDeathCharacterAvatar(
                          character: e,
