...
class BoardNoteCardPrototype extends StatelessWidget {
  const BoardNoteCardPrototype({
    super.key,
  });
                ...
                children: [
                  Flexible(
                    child: Column(
                      ...
                      children: [
                        const Text(
                          'kjfkdjfkdhjfldkfjdkfjkdlfjkdjfkdfjdkfjkdfj kdfjkdfjkdf kdjfkdfjkdnfkdnfd ',
                          maxLines: 200000,
                          style: TextStyle(
                            fontSize: 16,
