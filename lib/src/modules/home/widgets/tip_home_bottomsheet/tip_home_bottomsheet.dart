...
class TipHomeBottomsheet extends StatelessWidget {
  const TipHomeBottomsheet({super.key});
                ...
                child: Text.rich(
                  ...
                  TextSpan(
                    ...
                    children: [
                      ...
                      const TextSpan(text: '\n\n'),
                      const TextSpan(
                          text: '⋆ Crie suas ameaças e vincule a mesa.'),
                      const TextSpan(text: '\n\n'),
                      TextSpan(
                      ...
                      const TextSpan(text: '\n\n'),
                      const TextSpan(
                          text: '⋆ Vincule um personagem a está mesa'),
                      const TextSpan(text: '\n\n'),
                      const TextSpan(
                          text:
